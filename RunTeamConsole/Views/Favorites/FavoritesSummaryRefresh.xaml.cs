...
namespace RunTeamConsole.Views.Favorites
{
    /// <summary>
    /// Interaction logic for FavoritesSummaryRefresh.xaml
    /// </summary>
    public partial class FavoritesSummaryRefresh : UserControl
    {
        public FavoritesSummaryRefresh()
        {
            InitializeComponent();
        }
